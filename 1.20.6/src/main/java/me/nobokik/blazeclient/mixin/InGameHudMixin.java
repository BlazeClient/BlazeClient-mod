...
public class InGameHudMixin {
    ...
    private void armorhud$injectArmorHUD(DrawContext drawContext, float f, CallbackInfo ci) {
    ...
    public void renderStatusEffectOverlay(DrawContext drawContext, float f, CallbackInfo ci) {
    ...
    private void renderCrosshair(DrawContext drawContext, float f, CallbackInfo ci) {
